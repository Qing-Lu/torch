...
You must obtain the two .lib files mentioned in the code above: X:/torch/lapack/lib/libblas.lib and X:/torch/lapack/lib/liblapack.lib. Download [libblas.lib (x64)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win64/libblas.lib) and [liblapack.lib (x64)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win64/liblapack.lib) for Win64, or [libblas.lib (x86)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win32/libblas.lib) and [liblapack.lib (x86)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win32/liblapack.lib) for Win32. If any of those download links is broken, look for .lib downloads [here](http://icl.cs.utk.edu/lapack-for-windows/lapack/#libraries_mingw). Move them under your torch/lapack path so they become X:/torch/lapack/lib/libblas.lib and X:/torch/lapack/lib/liblapack.lib. In addition, you must also have the related .DLL files [libblas.dll (x64)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win64/libblas.dll) and [liblapack.dll (x64)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win64/liblapack.dll), or [libblas.dll (x86)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win32/libblas.dll) and [libblas.dll (x86)](http://icl.cs.utk.edu/lapack-for-windows/libraries/VisualStudio/3.7.0/Dynamic-MINGW/Win32/liblapack.dll). Broken? Try [here](http://icl.cs.utk.edu/lapack-for-windows/lapack/#libraries_mingw). Similarly, move those .DLLs under torch/lapack/lib/ as well Now you are ready for luarocks make!
...
To proceed with Torch installation, make sure that you have the following DLLs in your path. You can copy these DLLs to the directory into which you are going to install Torch, then add that directory to your PATH.
